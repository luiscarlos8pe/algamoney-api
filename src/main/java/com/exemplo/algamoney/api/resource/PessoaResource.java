...
public class PessoaResource {
	...
	@GetMapping("/{codigo}")
	public ResponseEntity<java.util.Optional<Pessoa>> buscarPeloCodigo(@PathVariable Long codigo) {
		java.util.Optional<Pessoa> pessoa = pessoaRepository.findById(codigo);
